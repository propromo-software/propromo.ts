<script lang="ts">
	...
	let url = '/dashboard/propromo-software/1/1?depth=info,issues&issue_states=open';
	$: id = url.trim();
...
<div class="flex flex-col max-w-full mx-auto w-[58rem]">
	<div class="grid grid-cols-1 gap-16 lg:grid-cols-[1fr_auto]">
		...
		<div class="px-8 mt-6 min-w-fit-content">
			<h1 style="line-height: 1;" class="uppercase text-[100px] font-headline text-primary lg:text-right text-center">Propromo</h1>
			<h2 style="line-height: 1;" class="lg:text-right text-center text-[48px] pr-[0.7px] text-gray-400 uppercase border-b-[5px] border-gray-400 font-headline">
	...
	<div class="flex flex-col px-8 mb-8">
		...
		<div class="flex gap-4">
			<Sl component={[ShoelaceComponentOptions.Input, ShoelaceComponentOptions.Button]}>
				...
				<sl-button variant="primary" size="large" href={id} class="text-2xl uppercase min-w-32" type="button">join</sl-button>
			</Sl>
		</div>
	</div>
</div>
